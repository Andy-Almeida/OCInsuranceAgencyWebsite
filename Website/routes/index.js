...
GetFunc('/Automotive', 'contents/automotive', 'Automotive', HeroPhoneBasic, './images/heros/carladysmile.jpg');
GetFunc('/CommercialVehicles', 'contents/commercialvehicles', 'Commercial Vehicles', HeroPhoneBasic, './images/heros/commercialtruck.jpg');
GetFunc('/Home', 'contents/home', 'Home', HeroPhoneBasic, './images/heros/house.jpg');
...
GetFunc('/Espanol', 'contents/espanol', 'Español', HeroPhoneBasic, './images/heros/womancafe.jpg');
GetFunc('/KnowledgeBase', 'contents/knowledgebase', 'Knowledge Base', HeroPhoneBasic, './images/heros/books.jpg');
GetFunc('/InsuranceFAQs', 'contents/index', 'Insurance FAQs', HeroPhoneBasic, './images/heros/question.jpg');
GetFunc('/HelpfulLinks', 'contents/helpfullinks', 'Helpful Links', HeroPhoneBasic, './images/heros/lasigns.jpg');
GetFunc('/Glossary', 'contents/index', 'Glossary', HeroPhoneBasic, './images/heros/openbooks.jpg');
